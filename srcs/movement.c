...
/*   Updated: 2024/11/02 13:30:37 by yalechin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player(t_mlx *mlx, double move_v, double move_h)
{
	...
	new_x = roundf(mlx->player->p_x + move_v);
	new_y = roundf(mlx->player->p_y + move_h);
	map_x = (new_x / S_SQUARE);
	map_y = (new_y / S_SQUARE);
